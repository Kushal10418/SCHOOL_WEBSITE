...
body{
    ...
    background:linear-gradient(135deg,#eef2f3,#d9e7f2);
    margin: 0;
    padding: 0;
}
 ...
 <body>
    <header>
        <div class="header-container">
            <img src="IT/kushal.jpg" alt="school-logo">
            <h1> KARANJALI STAR KIDS K.G SCHOOL</h1>
        </div>
    </header>
    <form action="admin backend.php" method="POST" id="contactForm"
    enctype="multipart/form-data">
        <h2>ADMIN REGISTRATION FORM</h2>
<div class="form-section">
    <label for="studentName">Admin Name</label>
    <input type="text" id="studentName" name="studentName" placeholder=" Enter your admin full name" required />
    ...
    <input type="text" id="mobile" name="mobile" pattern="[0-9]{10}" placeholder="10 digit mobile number" required />
